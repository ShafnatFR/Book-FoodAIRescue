...
Berikut adalah penjelasan lengkap mengenai diagram BPMN \textbf{As-Is} (sistem saat ini) yang telah dibuat. Penjelasan ini membedah alur kerja, interaksi antaraktor, serta mengidentifikasi kelemahan dari proses yang berjalan secara manual.
...
Berikut adalah penjelasan lengkap mengenai diagram BPMN \textbf{To-Be} (sistem usulan/harapan) yang menggambarkan alur proses setelah didigitalisasi menggunakan aplikasi.
