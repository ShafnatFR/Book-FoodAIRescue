...
\begin{landscape}
    \centering
    \vfill
    \includesvg[width=\linewidth, height=0.85\textheight, keepaspectratio, inkscapelatex=false]{image/bab3/Use Case}
...
\begin{longtable}{|p{0.4cm}|p{2.6cm}|p{3.4cm}|p{2.8cm}|p{3.6cm}|}
