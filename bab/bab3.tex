...
Perancangan antarmuka pengguna (\textit{User Interface}/UI) pada platform \textit{Food AI Rescue} dikembangkan dengan berlandaskan pada prinsip \textit{Human-Centered Design} (HCD). Mengacu pada hasil ekstraksi artefak \textit{User Experience} (UX) pada tahap analisis---seperti \textit{User Persona}, \textit{Empathy Map}, dan \textit{Customer Journey Map}---desain visual dirancang secara spesifik untuk memecahkan titik keluhan (\textit{pain points}) pengguna di lapangan. Subbab ini akan menjabarkan prinsip desain visual antarmuka, tata letak fungsional untuk masing-masing peran dalam ekosistem \textit{Role-Based Access Control} (RBAC), serta pemetaan alur navigasi kritis guna memastikan pengalaman pengguna yang intuitif, inklusif, dan responsif lintas perangkat.
