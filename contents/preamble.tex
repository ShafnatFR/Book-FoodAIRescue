...
% Column types for longtable (fixed width, compatible with longtable)
...
\usepackage{amssymb}
\usepackage{pifont}
\newcommand{\cmark}{\scalebox{1.2}{\textcolor{blue}{\ding{51}}}}%
\newcommand{\xmark}{\scalebox{1.2}{\textcolor{red}{\ding{55}}}}%
